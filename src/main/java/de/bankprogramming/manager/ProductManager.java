...
public class ProductManager {
	...
	public void processMortgageOrder(ProductType type, Customer owner, Double amount, Double interestRate, Double loanToValueLimit,
	...
	public void deposit(double amount,Account account){
		...
		Logger.logToFile("The Amount of "+amount+" has been deposit to the Account: "+account.getProductID()+".");
	}
	public void withdraw(double amount,Account account){

		this.addAmountTOBalance(account, amount);
		Logger.logToFile("The Amount of "+amount+" has been withdrawn from the Account: "+account.getProductID()+".");
	}

	public void createTransaction(double amount, long targetCustomerID, long targetAccount, long sourceCustomerID, long sourceAccount,
						 LocalDate triggerDate){
		Transaction t = new Transaction(amount,targetCustomerID,targetAccount,sourceCustomerID,sourceAccount,triggerDate);
	...
	public void executeTransaction(Transaction t){
		...
		Logger.logToFile("The amount of: "+t.getAmount()+" at the Time: "+t.getTimestamp()+" from the source Account: "+ t.getSourceAccount()+" by the Customer: "+ t.getSourceID()+" to the Account: "+ t.getTargetAccount()+"by the Customer: "+t.getTargetID()+"triggerd at: "+t.getTriggerDate());
	}
